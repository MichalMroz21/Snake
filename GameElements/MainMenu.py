...
class MainMenu:
    ...
    def __init__(self):
        ...
        self.OPTIONS_APPLY = None
        self.OPTIONS_RESOLUTION = None
        self.OPTIONS_RECT_RESOLUTION = None
        self.OPTIONS_TEXT_RESOLUTION = None
        ...
        self.BG = None
        self.screen = None
        self.OPTIONS_TEXT_MUSIC = None
        self.OPTIONS_RECT_MUSIC = None
        self.OPTIONS_MUSIC_SLIDER = None
        self.OPTIONS_TEXT_SOUND = None
        self.OPTIONS_RECT_SOUND = None
        self.OPTIONS_SOUND_SLIDER = None
        ...
        self.RESOLUTIONS = [(640, 480), (800, 600), (1024, 768), (1280, 800), (1440, 900), (1680, 1050), (1920, 1200),
    ...
    def resolution_init(self, first_time=True):
        ...
        self.OPTIONS_BACK = Button(image=None, pos=(self.screenWidth / 2, self.screenHeight / 1.1),
                                   text_input="GO BACK",
                                   font=self.Font.get_normal_font(smaller=2), base_color="White", hovering_color="Red")
        ...
        self.OPTIONS_RESOLUTION = Button(image=None, pos=(self.screenWidth / 2, self.screenHeight / 3.0),
                                         ...
                                         font=self.Font.get_normal_font(smaller=2), base_color="White",
                                         hovering_color="Red")
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if self.PLAY_BUTTON.check_for_input(self.MENU_MOUSE_POS):
                        lobby = Lobby(self.screen, self.screenWidth, self.screenHeight, self.FPS, self.mixer, self,
                                      self.Font)
                        lobby.display_lobby()
